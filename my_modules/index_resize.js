...
function resize_div_mouse_down(e) {
    is_resizing = true;
}
function resize_div_mouse_up() {
    is_resizing = false;
}
function has_scroller() {
...
function resize_div_mouse_move(e) {
    if (!is_resizing)
        return;
    var resize_div = document.getElementById("resize_div");
    if (resize_div == null)
...
function mouse_move_main_iframe(e) {
...
export function set_iframe(html_link) {
    var main_iframe = document.getElementById("main_iframe");
    // @ts-ignorex
...
//# sourceMappingURL=index_resize.js.map